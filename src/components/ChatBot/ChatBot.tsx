...
const ChatBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    {
      id: "4",
      text: "If you need further assistance, contact support team.",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
  ...
  const generateBotResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes("price") || lowerMessage.includes("cost")) {
      return "Our products range from ₹500 for small decor items to ₹80,000+ for furniture sets. Design consultations start at ₹7,999. Would you like me to help you find something within a specific budget?";
    }
